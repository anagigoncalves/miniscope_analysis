...
ax.set_title('Phase tuning', fontsize=20)
ax.set_title('Step cycle baseline tuning', fontsize=20)
plt.gca().invert_yaxis()
cbar = plt.colorbar(sc)
cbar.ax.tick_params(labelsize=20)
cbar.mappable.set_clim([0, 100])
plt.savefig(os.path.join(save_path, 'roi_map_phase_max_colorcode_' + align_event + '_' + align_dimension), dpi=256)
plt.savefig(os.path.join(save_path, 'roi_map_phase_max_colorcode_' + align_event + '_' + align_dimension + '.svg'), dpi=256)