...
plt.figure()
plt.plot(FR_X_excursion[0][100:500], color = 'red')
plt.plot(FL_X_excursion[0][100:500], color = 'blue')
plt.plot(FR_X_excursion[0][100:500]-FL_X_excursion[0][100:500], color='black')
plt.title('baseline')
plt.ylim([-90, 90])

plt.figure()
plt.plot(FR_X_excursion[3][500:1000], color = 'red')
plt.plot(FL_X_excursion[3][500:1000], color = 'blue')
plt.plot(FR_X_excursion[3][500:1000]-FL_X_excursion[0][500:1000], color='black')
plt.title('split')
plt.ylim([-90, 90])
