...
for i in range(len(event_count_loco_split_all)):
    ...
    plt.scatter(np.repeat(1, len(event_count_loco_baseline_all[i]))+np.random.rand(len(event_count_loco_baseline_all[i])), event_count_loco_baseline_all[i], s=5, color=get_colors_plot(event_count_loco_animals[i], color_animals))
